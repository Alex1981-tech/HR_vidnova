...
- **Лишилось / tech-debt (низький пріоритет, фоном):**
  - ⬜ Mobile: attendance-table → stacked-cards на телефоні (зараз горизонт-скрол) — потребує JSX-зміни в App.tsx, не лише CSS. Фільтри→bottom-sheet — теж JSX.
