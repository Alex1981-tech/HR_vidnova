...
- **Далі:** ⬜ Фаза 5 (mobile: drawer, stacked-tables, bottom-sheet) — більший блок, після перевірки десктопу Alex. ⬜ Фаза 6 (dark без !important-спаму). ⬜ Фаза 7 (розбити моноліти).
